...
<br>최근에 조선 전기 15세기 아카이브를 설계하는데 풀스택으로 작업해야해서 공부하면서 배우는대로 진행 중이다. (현재 상태는 완전히 HTML과 기초적인 CSS로 이루어진 정적페이지일뿐.) 혼자 스크래치로 밑바닥부터 작업하려니 좀 오래 걸리기는 하겠지만 독보적인 글로벌 인문테크솔루션 기업이 되기 위해 지금은 그저 묵묵히 기초를 다지고 침묵하는 시기로 생각하고 성장하고 버티자.
